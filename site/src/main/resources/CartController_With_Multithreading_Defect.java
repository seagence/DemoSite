...
public class CartController extends BroadleafCartController {
    ...
    public @ResponseBody Map<String, Object> addJson(HttpServletRequest request, HttpServletResponse response, Model model,
        ...
        try {
        	String message = readMessage("cart.item.added");
...
//                responseMap.put("openCart", true);
            ...
            responseMap.put("itemAdded", message);
            response.addHeader("result", "success");
        } catch (Exception e) {
			// swallow the exception for the demo purpose
        }
        return responseMap;
    }
    ...
    public static String readMessage(String labelName) throws Exception {
		String messagespath = CartController.class.getClassLoader().getResource("site-messages.xml").getPath();
    	FileReader fr = new FileReader(messagespath);
